...
I build things that don't exist yet. I'm a Data Science Master's student at Ateneo de Manila University, and a BS Applied Mathematics graduate from the same school. This means my projects tend to start in one of two places: (1) data that hasn't been collected or structured yet, which pulls me into scraping, warehousing, and cleaning text that was never meant to be analyzed, or (2) a mathematical idea I think belongs inside a machine learning or deep learning architecture, which pulls me past the library that implements a model and into the structure underneath it. On the surface these look like two different kinds of work, one closer to engineering, the other closer to theory. However, both come from the same refusal to accept a method at face value until I understand why it holds. This blog is where that curiosity gets written down.
